...
### 📖 五大步驟深度強化 ⭐ NEW
基於《規劃最好的一年》五大步驟，每一步都有對應功能：

| 步驟 | 功能 | 說明 |
|------|------|------|
| 1️⃣ 相信可能 | 限制性信念清單 + AI賦能回應 | 勾選10條常見信念，AI即時生成轉化視角 |
| 1️⃣ 相信可能 | 信念轉化Prompt系統 | AI教練+夥伴所有對話自動嵌入信念引導 |
| 2️⃣ 總結過去 | 年度回顧 + AI經驗萃取報告 | 4步引導：成就→遺憾→教訓→AI洞察 |
| 3️⃣ 找到為什麼 | 3個動機 + AI動機卡片 | 連續3天未打卡自動顯示動機提醒 |
| 4️⃣ 設定目標 | SMARTER評分器 | 7維度即時評分+AI改進建議 |
| 4️⃣ 設定目標 | 領先/滯後指標 | 區分可控行動vs結果，專注可控指標 |
| 4️⃣ 設定目標 | 更少但更好：待棄清單 | 記錄決定不做的事，騰出空間 |
| 5️⃣ 付諸行動 | 4種AI教練風格 | 嚴格軍官/溫暖鼓勵/理性分析/幽默夥伴 |
| 5️⃣ 付諸行動 | 一鍵批量打卡 + 補卡機制 | 反思式補卡，非完美記錄 |
